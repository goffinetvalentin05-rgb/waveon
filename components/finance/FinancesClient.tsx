  ...
  return (
    <div className="space-y-6">
      {projectId ? null : (
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-wo-muted">Dépenses, partages, sans comptabilité lourde.</p>
          </div>
      ...
      <div className={`${ui.statCard} max-w-xs`}>
        <p className="text-[10px] font-medium uppercase tracking-[0.08em] text-wo-muted">Ce mois</p>
          ...
          {expenses.map((e) => (
            <div key={e.id} className={`${ui.card} flex items-center justify-between gap-3 px-4 py-3`}>
              <div className="min-w-0">
                <p className="truncate text-sm font-medium text-wo-text">{e.title}</p>
